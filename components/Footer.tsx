...
const Footer = () => (
  <footer className="bg-gradient-to-b from-dacolors-purple via-dacolors-blue to-dacolors-cyan relative px-4 lg:px-36 text-white">
    ...
    <div className="pt-40 flex flex-col gap-8 items-start pb-12">
      ...
      <p className="w-3/4 md:w-1/2 text-lg">
        ...
        tenemos por desarrollar productos digitales de calidad mundial. Somos un
        equipo de 220+ dacoders especializados en la planeación, diseño,
        desarrollo, implementación e innovación continua de productos digitales
        disruptivos.
      </p>
      <div>
        <Image
