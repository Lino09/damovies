...
const Button = ({
  ...
  const varianStyles = {
    primary:
      "cursor-pointer bg-gradient-to-r from-dacolors-cyan via-dacolors-blue to-dacolors-purple shadow-md hover:scale-105",
    secondary:
      "cursor-pointer bg-dacolors-bgc border border-white shadow-md hover:scale-105",
